...
if (!preg_match("/^[0-9.]+[-]?+[0-9kK]{1}/", $txtRut)) {
    return array('error' => true, 'msj' => 'Error al digitar el RUT');
}

$rutV = preg_replace('/[\.\-]/i', '', $txtRut);
$dv = substr($rutV, -1);
